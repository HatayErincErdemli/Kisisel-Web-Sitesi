    ...
    >
      <div className=" flex flex-row justify-end pt-4 space-x-4">
        {lang === "tr" ? (
          <button
            onClick={() => changeLang()}
            className="text-base text-[#cbf180] dark:text-[#b7aee3] font-bold"
          >
      ...
      <div className="pt-8 pb-40 flex flex-row items-center justify-between content-center max-xl:flex-col max-xl:gap-8 ">
        <div className="flex flex-col gap-8 m-0 max-w-md">
          <h2 className="text-5xl text-[#cbf180] font-bold max-xl:text-center">
            {langData.hero.intro}
          </h2>
          <p className="text-2xl text-white max-xl:text-center">
            {langData.hero.intro_2}
          </p>
          <div className="flex text-xl text-indigo-800 flex-row items-center space-x-4 max-xl:justify-center">
        ...
        <div className="">
          <img
            ...
            alt=""
            className="m-0 p-0 size-72 rounded-lg"
          />
        </div>
      </div>
    </div>
